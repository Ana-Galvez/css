...
3. position:absolute  -  para que sea relativo al padre, el padre debe tener position:relative o position:fixed. Permite el uso de left, top, right y bottom, pero le da prioridad a left y top. Además al mover el elemento, su lugar original es ocupado por otro elemento.